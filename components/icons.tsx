...
export const ThumbsUpIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M7 10v12"></path><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h0a2 2 0 0 1 3 3.88V10"></path>
    </svg>
);
...
export const MenuIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span className="material-symbols-outlined" {...props}>menu</span>
);

export const VerifiedUserIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span className="material-symbols-outlined text-3xl" {...props}>verified_user</span>
);

export const BadgeIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span className="material-symbols-outlined text-3xl" {...props}>badge</span>
);

export const HubIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span className="material-symbols-outlined text-3xl" {...props}>hub</span>
);

export const FacebookIcon: React.FC<IconProps> = (props) => (
    <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path clipRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.044 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" fillRule="evenodd"></path>
    </svg>
);
...
export const AppleIcon: React.FC<IconProps> = (props) => (
    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.74s2.57-.99 4.31-.74c.58.03 2.21.21 3.24 1.73-2.9 1.76-2.4 5.37.52 6.53-.47 1.25-1.12 2.53-2.14 3.71-.51.64-1.05 1.05-1.01 1zM13 3.5c.54-1.57 2.25-2.43 3.81-2.5-.27 2.05-2.14 3.81-3.81 3.65-.17-1.39.05-1.15 0-1.15z" />
    </svg>
);
...
export const HandshakeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m19 14 2-2-1.5-1.5a2.121 2.121 0 0 0-3 0l-1.66 1.66-1.5-1.5 4.24-4.24a2.121 2.121 0 0 0-3-3L10.5 7.08l-3.18-3.18a2 2 0 0 0-3.18 3.54L6 9.34l-2.34 2.34a2 2 0 0 0 0 2.82l6.36 6.36a2 2 0 0 0 2.83 0l7-7z"></path>
    </svg>
);
